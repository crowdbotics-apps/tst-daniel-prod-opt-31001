...
## Project Structure
    ...
    ├── tst_daniel_prod_opt_31001  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_prod_opt_31001`
...
2. Clone this repo and `cd tst_daniel_prod_opt_31001`
